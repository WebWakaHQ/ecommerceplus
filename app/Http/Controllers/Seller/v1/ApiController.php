...
class ApiController extends Controller
{
        ...
        */
        ...
        if ($validationResponse = validateRequest($request, $rules)) {
            ...
            if (Auth::attempt($credentials)) {
                ...
                // }
                $output['store_data'] = formatStoreData($store_data, $isPublicDisk);
    ...
    public function get_delivery_boys(Request $request)
    {
        ...
        if ($validationResponse = validateRequest($request, $rules)) {
            ...
            $seller_store = DB::table('seller_store')->where('user_id', $user_id)->where('store_id', $store_id)->select('city', 'zipcode', 'deliverable_zones')->get();
            ...
            $data = getDeliveryBoys($id, $search, $offset, $limit, $sort, $order, $seller_city, $seller_zipcode, $store_deliverability_type, $seller_zone_ids);
            return response()->json($data);
        }
    }
