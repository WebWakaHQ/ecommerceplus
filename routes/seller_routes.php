...
Route::group(
    ...
    function () {
        ...
        Route::post('/seller/update_product_deliverability', [ProductController::class, 'update_product_deliverability'])->name('seller.deliverability.bulk.update');
        ...
        Route::post('/seller/update_combo_product_deliverability', [ComboProductController::class, 'update_product_deliverability'])->name('seller.combo.deliverability.bulk.update');
    }
