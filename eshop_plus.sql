...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2025 at 02:59 AM
...
(1, 'English', 'en', 0, '2025-02-12 05:15:34', '2025-02-12 05:15:34');
...
(36, '1.0.2', '2024-06-06 06:38:08', '2024-06-06 06:38:08');
...
CREATE TABLE `zones` (
  `id` int(11) NOT NULL,
  `name` varchar(256) DEFAULT NULL,
  `serviceable_city_ids` varchar(256) DEFAULT NULL,
  `serviceable_zipcode_ids` varchar(256) DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
