                    ...
                    <div class="row align-items-center">
                        <div class="col-4 col-sm-4 col-md-5 col-lg-5 col-xl-6 align-self-center icons-col text-left d-xl-none">
                            ...
                            <div class="account-parent iconset d-inline-block d-xl-none">
                                <div class="account-link"><span class="iconCot"><i class="hdr-icon icon anm anm-user-al"></i></div>
                                <div id="accountBox">
                        ...
                        <div class="col-4 col-sm-4 col-md-5 col-lg-5 col-xl-6 align-self-center icons-col text-right">
                            ...
                            <div class="compare-link d-none d-xl-inline-block iconset">
                                <a wire:navigate class="icon-link clr-none d-flex" data-bs-toggle="offcanvas"
                                    data-bs-target="#search-drawer">
                                    <span class="iconCot"><ion-icon wire:ignore class="fs-5"
                            ...
                            <div class="account-link iconset d-none d-xl-inline-block">
                                <div class="account-parent iconset">
                                    <div class="account-link" title="Account"><span class="iconCot">
                                            <ion-icon wire:ignore name="person-outline" class="fs-5"></ion-icon>
                                        </span></div>
                                    <div id="accountBox">
                                        <div class="customer-links">
                                            <ul class="m-0">
                                                @auth
                                                    ...
                                                    <li><a href="{{ customUrl('my-account/wallet') }}"
                                                            wire:navigate><ion-icon name="wallet-outline"
                                                                class="me-1"></ion-icon>{{ labels('front_messages.wallet', 'Wallet') }}</a>
                                                    </li>
                                                    <li><a class="logout"><ion-icon wire:ignore name="log-out-outline"
                                                                class="me-1"></ion-icon>{{ labels('front_messages.sign_out', 'Sign out') }}</a>
                                                ...
                                                @else
                                                    <li><a href="{{ customUrl('login') }}" wire:navigate><ion-icon
                                                                wire:ignore name="log-in-outline"
                                                                class="me-1"></ion-icon>{{ labels('front_messages.sign_in', 'Sign In') }}</a>
                                                    </li>
                                                    <li><a href="{{ customUrl('register') }}" wire:navigate><ion-icon
                                                                name="person-outline"
                            ...
                            <div class="header-cart iconset pe-0">
                                <a href="#;" class="header-cart btn-minicart icon-link clr-none d-flex"
                                    ...
                                    <span class="iconCot"><ion-icon wire:ignore class="fs-5"
                                            name="cart-outline"></ion-icon></i><span
