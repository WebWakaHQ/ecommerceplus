@props(['details'])
{{-- @dd($details->cal_discount_percentage); --}}
            ...
            <div class="product-image">
                ...
                @if ($details->min_max_price['discount_in_percentage'] != 0 && $details->min_max_price['discount_in_percentage'] != 100)
                    <div class="product-labels round-pill">
                        <span class="lbl pr-label2">{{ round($details->min_max_price['discount_in_percentage']) }}%</span>
                    </div>
                @endif
                ...
                <div class="button-bottom-action style1">
                    <div class="button-left">
                        @if ($details->type == 'variable_product')
                            <div class="addtocart-btn add_cart">
                                <a href="#quickview-modal"
                                    ...
                                    <ion-icon name="bag-handle-outline" class="mx-1"></ion-icon><span
                        ...
                        @else
                            <div class="addtocart-btn add_cart" id="add_cart"
                                ...
                                data-brand-name='{{ $details->brand_name }}'
                    ...
                    <div class="button-right">
                        <a href="#quickview-modal" class="btn-icon quickview quick-view-modal" data-bs-toggle="modal"
                            ...
                            <ion-icon name="search-outline" class="fs-6"></ion-icon>
                        </a>
                        <a class="btn-icon wishlist card_fav_btn {{ $details->is_favorite == 1 ? 'remove-favorite' : 'add-favorite' }}"
                            data-bs-placement="top" title="Add To Wishlist" tabindex="0"
                        ...
                        <a class="btn-icon compare add-compare" data-product-id="{{ $details->id }}"
                            data-bs-placement="top" title="Add to Compare"><ion-icon name="shuffle-outline"
                                class="fs-6"></ion-icon></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="product-image">
                <a class="product-img" tabindex="0">
                    ...
                    @if ($details->cal_discount_percentage != 0)
                        <div class="product-labels round-pill">
                            <span class="lbl pr-label2">{{ round($details->cal_discount_percentage) }}%</span>
                        </div>
                    @endif
                ...
                <div class="button-bottom-action style1 product_card_style_3">
                    ...
                    <div class="button-right">
                        ...
                        <a class="btn-icon compare add-compare" data-product-id="{{ $details->id }}"
                            ...
                            data-bs-original-title="Add to Compare" aria-label="Add to Compare"><ion-icon
                                name="shuffle-outline" class="fs-6"></ion-icon></a>
                    </div>
                </div>
            </div>
        </div>
