         ...
         <ul class="navbar-nav" id="menuList">
             ...
             <li class="nav-item ">
                <a class="nav-link manage_product_deliverability {{ Request::is('seller/manage_product_deliverability') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ">{{ labels('admin_labels.manage_product_deliverability', 'Product Deliverability Manage') }}</span>
                </a>
            </li>
             <li class="nav-item ">
                <a class="nav-link manage_product_deliverability {{ Request::is('seller/manage_combo_product_deliverability') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ">{{ labels('admin_labels.manage_combo_product_deliverability', 'Combo Product Deliverability Manage') }}</span>
                </a>
            </li>
