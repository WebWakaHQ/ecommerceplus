                            ...
                            <div class="col col-xxl-12">
                                <div class="card p-5">
                                    ...
                                    <div class="form-group col-md-12 mb-4">
                                        ...
                                        <iframe id="web_home_page_theme_iframe" src="/admin/web_home_page_theme"></iframe>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select class="wishlist_display_style_for_web form-control form-select"
                                                        ...
                                                        <option
                                                            ...
                                                            value="wishlist_display_style_for_web_1">Style 1</option>
                                                        <option
                                                            {{ $store_settings->wishlist_display_style_for_web ?? ''== 'wishlist_display_style_for_web_2' ? 'selected' : '' }}
                                                            value="wishlist_display_style_for_web_2">Style 2</option>
                                                    </select>
                                                    <iframe class="overflow-hidden"
