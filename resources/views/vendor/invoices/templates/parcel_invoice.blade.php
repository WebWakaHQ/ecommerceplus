                                    ...
                                    <div class="print-section">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <h3 class="text-right">
                                                        {{ labels('front_messages.mo', 'Mo') }}.{{ $invoice->seller->custom_fields['mobile_number'] }}
                                                    </h3>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td class="text-left">
                                                    ...
                                                    {{ $invoice->buyer->custom_fields['date_added'] }}
                                                </td>
                                                ...
                                                <table class="table borderless text-center text-sm">
                                                    <thead class="">
                                                        <tr>
                                                            ...
                                                            <th>{{ labels('front_messages.tax_percent', 'Tax (%)') }}
                                                            </th>
                                                            <th>{{ labels('front_messages.tax_amount', 'Tax Amount (₹)') }}
                                                            </th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($invoice->getCustomData() as $row)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ formateCurrency(formatePriceDecimal($price_without_tax)) }}<br>
                                                                </td>
                                                                <td>{{ $row->tax_percent ? $row->tax_percent : '0' }}<br>
                                                                </td>
                                                    ...
                                                    <table class="table borderless text-sm text-right">
                                                        <tr>
                                                            <td>{{ labels('front_messages.total_order_price', 'Total Order Price') }}
                                                                ({{ $currency_symbol }})</td>
                                                            {{-- <td>+ {{formatePriceDecimal($sub_total)}} </td> --}}
                                                        </tr>
                                                        <tr>
                                        ...
                                        <table class="table">
                                            <tr>
                                                <td></td>
                                                <td class="text-right">
                                                    <p>{{ isKeySetAndNotEmpty($settings, 'app_name') ? $settings['app_name'] : '' }}</p>
