...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.manage_product_deliverability', 'Deliverability Manage') }}
            </h3>
            <p class="sub_title">
                {{ labels('admin_labels.elevate_your_store_with_seamless_deliverability_management', 'Elevate Your Store with Seamless Product Deliverability Management') }}
            </p>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                        ...
                                        <a class="btn me-2" id="tableFilter" data-bs-toggle="offcanvas"
                                            data-bs-target="#columnFilterOffcanvas" data-table="seller_combo_deliverability_table"
                                            StatusFilter='true'><i class='bx bx-filter-alt'></i></a>
                                        <a class="btn me-2" id="tableRefresh" data-table="seller_combo_deliverability_table"><i
    ...
    <div class="modal fade" id="deliverabilityModal" tabindex="-1" aria-labelledby="deliverabilityModalLabel" aria-hidden="true">
                ...
                <form id="combodeliverabilityForm">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select search_seller_zone" name="deliverable_zones[]" id="deliverable_zones" multiple>
                            </select>
                        </div>
